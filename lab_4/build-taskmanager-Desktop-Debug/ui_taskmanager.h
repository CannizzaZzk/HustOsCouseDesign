...
public:
    ...
    void setupUi(QWidget *TaskManager)
    {
        ...
        label_memused->setObjectName(QStringLiteral("label_memused"));
        ...
        progressBar_cpu0->setObjectName(QStringLiteral("progressBar_cpu0"));
        progressBar_cpu0->setGeometry(QRect(40, 130, 118, 23));
        progressBar_cpu0->setValue(24);
        progressBar_cpu1 = new QProgressBar(groupBox_3);
        progressBar_cpu1->setObjectName(QStringLiteral("progressBar_cpu1"));
        ...
        progressBar_cpu2->setObjectName(QStringLiteral("progressBar_cpu2"));
        ...
        progressBar_cpu3->setObjectName(QStringLiteral("progressBar_cpu3"));
        ...
        progressBar_disk1->setObjectName(QStringLiteral("progressBar_disk1"));
        ...
        progressBar_disk2->setObjectName(QStringLiteral("progressBar_disk2"));
        ...
        progressBar_disk3->setObjectName(QStringLiteral("progressBar_disk3"));
    ...
    {
        TaskManager->setWindowTitle(QApplication::translate("TaskManager", "TaskManager", Q_NULLPTR));
        pushButton->setText(QApplication::translate("TaskManager", "\347\273\223\346\235\237\350\277\233\347\250\213", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("TaskManager", "\350\277\233\347\250\213", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("TaskManager", "Memory Usage", Q_NULLPTR));
        label_memused->setText(QApplication::translate("TaskManager", "TextLabel", Q_NULLPTR));
        label_memtotal->setText(QApplication::translate("TaskManager", "TextLabel", Q_NULLPTR));
        groupBox_3->setTitle(QApplication::translate("TaskManager", "Cpu Usage", Q_NULLPTR));
        label->setText(QApplication::translate("TaskManager", "core0", Q_NULLPTR));
        label_2->setText(QApplication::translate("TaskManager", "core1", Q_NULLPTR));
        label_3->setText(QApplication::translate("TaskManager", "core2", Q_NULLPTR));
        label_4->setText(QApplication::translate("TaskManager", "core3", Q_NULLPTR));
        label_5->setText(QApplication::translate("TaskManager", "usage", Q_NULLPTR));
        groupBox_4->setTitle(QApplication::translate("TaskManager", "Disk Usage", Q_NULLPTR));
        label_6->setText(QApplication::translate("TaskManager", "disk1", Q_NULLPTR));
        label_11->setText(QApplication::translate("TaskManager", "disk2", Q_NULLPTR));
        label_14->setText(QApplication::translate("TaskManager", "disk3", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("TaskManager", "\346\200\247\350\203\275", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("TaskManager", "Page", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("TaskManager", "Page", Q_NULLPTR));
    } // retranslateUi
